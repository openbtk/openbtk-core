...
> that were never executable (three conflicting package names in one repository) and
> has been removed. The current phase is complete: specification, architecture and
> planning.
>
...
compliance, test charter, roadmap, ADRs) are maintained outside this repository and
are not published here. Public documentation ships with the v0.1 release.
