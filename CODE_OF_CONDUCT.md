...
requests, discussions, and any other forum this project uses), and also
applies when an individual is officially representing the community in
public spaces.

## Enforcement

This project does not yet have a dedicated conduct-reporting email. Instances
of abusive, harassing, or otherwise unacceptable behavior may be reported by:

- Opening a [private security advisory](https://github.com/openbtk/openbtk-core/security/advisories/new)
  on this repository (despite the name, maintainers monitor this channel and
  it supports private, non-public reports); or
- Contacting a project maintainer directly through their GitHub profile.
